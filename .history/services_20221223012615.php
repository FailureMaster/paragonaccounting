...
<body>
    ...
    <section class="container services">
        ...
        <div class="row service-offer">
            ...
            <div class="service-box services_page_box">
                <div class="col-5">
                    <img class="services_image" src="http://paragon.canadianwebdesigns.net/wp-content/uploads/elementor/thumbs/discussing-new-strategy-px2yw6pdgj14sw4k4a0g0c74wpogx7ipzi7rtdf7fc.jpg" alt="Personal Taxes">
                </div>
                <div class="col-6">
            ...
            <div class="service-box services_page_box">
                <div class="col-5">
                    <img class="services_image" src="https://templatekit.jegtheme.com/acctual/wp-content/uploads/sites/58/2021/03/bookkeeping.png" alt="Personal Taxes">
                </div>
                <div class="col-6">
